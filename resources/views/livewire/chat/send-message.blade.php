<div class="flex py-6 px-20 border-t">
    <input class="border-none px-4 py-2 bg-gray-100 w-full focus:outline-none" type="text" placeholder="Type here...">
    ...
    <a class="bg-purple-600 text-white rounded px-4 py-2">Enviar</a>
</div>